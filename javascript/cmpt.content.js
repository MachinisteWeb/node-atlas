...
website.component.Content = function () {
	...
	publics.hashChange = function () {
		window.addEventListener("hashchange", function () {
			//website.goToHash(document.getElementsByClassName(publics.name + "--inner"), location.hash.replace("#", ""));
			document.getElementsByClassName(publics.name + "--inner").scrollTop = document.getElementById(location.hash.replace("#", "")).offsetTop;
		});
	};
