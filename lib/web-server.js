 ...
 */
exports.response = function (request, response, data, routeParameters, currentVariation) {
    var NA = this,
        header,
         ...
         * @default "utf-8"
         */
        charset = currentVariation.routeParameters.charset || routeParameters.charset || NA.webconfig.charset,
         ...
         * @default 200
         */
        statusCode = currentVariation.routeParameters.statusCode || routeParameters.statusCode || 200,
         ...
         * @default "text/html"
         */
        mimeType = currentVariation.routeParameters.mimeType || routeParameters.mimeType || NA.webconfig.mimeType,
         ...
         * @default "text/html"
         */
        headers = currentVariation.routeParameters.headers || routeParameters.headers || {};
