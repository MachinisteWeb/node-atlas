...
exports.simpleWebServer = function () {
    var NA = this,
        ...
        urlOutput = url.resolve('http://localhost' + ((httpPort !== 80) ? ":" + httpPort : "") + '/', ((typeof NA.configuration.browse === 'string') ? NA.configuration.browse : ""));
...
exports.startingHttpServer = function () {
    ...
    if (!NA.configuration.generate) {
        if (typeof NA.webconfig.httpSecure === "object" && NA.webconfig.httpSecureRelativeKeyPath && NA.webconfig.httpSecureRelativeCertificatePath) {
