...
exports.openConfiguration = function (configName) {
    ...
    try {
        ...
        return JSON.parse(fs.readFileSync(path.join(NA.serverPath, configName), "utf-8"));
    } catch (exception) {
...
exports.common = function (languageCode, locals) {
    ...
    locals.common = NA.openVariation(NA.webconfig.commonVariation, languageCode);
...
exports.view = function (viewFile, locals) {
    ...
    if (typeof locals.enablePug === "boolean") {
        engine = locals.enablePug ? pug : ejs;
    }
