...
exports.newRender = function (viewFile, variations) {
    ...
    variations.filename = path.join(NA.variations.pathname, viewFile);

    if (variations.currentRouteParameters && typeof variations.currentRouteParameters.enablePug === "boolean") {
        engine = variations.currentRouteParameters && variations.currentRouteParameters.enablePug ? pug : ejs;
    }
