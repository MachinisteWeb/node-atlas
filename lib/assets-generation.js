...
exports.urlGeneratingPages = function () {
    var NA = this,
        ...
        path = NA.modules.path,
        data = {},
        htmlGenerationEnable = true;

    /* Avoid copy of `assetsRelativePath` into `serverlessRelativePath` even if serverlessRelativePath directory exist. */
    if (typeof NA.webconfig.htmlGenerationEnable === 'boolean') {

        /**
         * Disable HTML generation mechanism.
         * @public
         * @alias htmlGenerationEnable
         * @type {boolean}
         * @memberOf NA#webconfig
         * @default true
         */
        htmlGenerationEnable = NA.webconfig.htmlGenerationEnable;
    }
 ...
 * @this NA
 */
function traverse(paths, callback) {
    var NA = this,
        copyDir = NA.modules.copyDir,
        path = NA.modules.path,
 ...
 * @this NA
 */
exports.staticsGeneration = function (callback) {
    var NA = this,
 ...
 * @this NA
 */
exports.publicsGeneration = function (callback) {
    var NA = this,
        path = NA.modules.path,
        fs = NA.modules.fs,
        copyDir = NA.modules.copyDir,
        ...
        assetsCopyEnable = true;

    /* Avoid copy of `assetsRelativePath` into `serverlessRelativePath` even if serverlessRelativePath directory exist. */
    if (typeof NA.webconfig.assetsCopyEnable === "boolean") {

        /**
         * Disable Assets generation mechanism.
         * @public
         * @alias assetsCopyEnable
         * @type {boolean}
         * @memberOf NA#webconfig
         * @default true
         */
        assetsCopyEnable = NA.webconfig.assetsCopyEnable;
    }

    if (assetsCopyEnable && sourcePath !== destinationPath && fs.existsSync(sourcePath)) {
        copyDir(sourcePath, destinationPath, function () {        
