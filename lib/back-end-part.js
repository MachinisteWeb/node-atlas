...
exports.cssAlreadyParse =  function (NA) {
     ...
     */
    NA.cssAlreadyParse = function (newPath, allCssFiles, inject) {
...
exports.injectCssAuth =  function (NA) {
     ...
     * @param {string}         inject      - State for know if injection will be authorized.
     */
    NA.injectCssAuth = function (pathFile, allCssFiles, inject) {
        var path = NA.modules.path;
...
exports.prepareCssInjection =  function (NA) {
     ...
     * @memberOf node-atlas~NA
     */
    NA.prepareCssInjection = function (allCssFiles, injection) {
        var path = NA.modules.path,
            inject = true,
...
exports.injectCss =  function (NA) {
     ...
     */
    NA.injectCss = function (dom, injection, mainCallback) {
...
exports.lessCompilation =  function (NA) {
     ...
     */
    NA.lessCompilation = function (callback) {
...
exports.cssMinification =  function (NA) {
     ...
     */
    NA.cssMinification = function (callback) {
...
exports.imgOptimization =  function (NA) {
     ...
     */
    NA.imgOptimization = function (callback) {
...
exports.jsObfuscation =  function (NA) {
     ...
     */
    NA.jsObfuscation = function (callback) {
        var bundles = NA.webconfig.bundles,
...
exports.loadListOfExternalModules = function (NA) {
     ...
     */
    NA.loadListOfExternalModules = function (callback) {
...
exports.loadController = function (NA) {
     ...
     */
    NA.loadController = function (controller, callback) {
        var path = NA.modules.path,
