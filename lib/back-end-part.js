...
exports.loadListOfExternalModules = function (callback) {
    ...
    NA.loadController(NA.webconfig.commonController, function () {
        ...
        /* Use the `NA.websiteController[<commonController>].setModules(...)` function if set... */
        if (typeof NA.websiteController[NA.webconfig.commonController] !== 'undefined' &&
            typeof NA.websiteController[NA.webconfig.commonController].setModules !== 'undefined') {
             ...
             */
            NA.websiteController[NA.webconfig.commonController].setModules.call(NA);
        }
