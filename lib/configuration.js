 ...
 * @this NA
 */
exports.initServerModules = function (next) {
	var NA = this;
	...
	if (typeof NA.controllers[NA.webconfig.controller] !== 'undefined' &&
		...
		if (NA.controllers[NA.webconfig.controller].setModules[Symbol.toStringTag] === 'AsyncFunction') {
			NA.controllers[NA.webconfig.controller].setModules.call(NA).then(function () {
				next();
			});
		} else {
