 ...
 */
function noCache(NA, staticOptions) {
    /* No Cache */
...
exports.simpleWebServer = function () {
    ...
    staticOptions = noCache(NA, staticOptions);
...
exports.nodeAtlasWebServer = function (next, fallback) {
    ...
    /* Change Engine */
    if (NA.webconfig.commonEngine) {
        NA.express.set("view engine", NA.webconfig.commonEngine);
...
exports.initSessions = function (next, fallback) {
    ...
    if (typeof NA.controllers[NA.webconfig.commonController] !== 'undefined' &&
        typeof NA.controllers[NA.webconfig.commonController].setSessions !== 'undefined') {
             ...
             */
            NA.controllers[NA.webconfig.commonController].setSessions.call(NA, function () {
...
exports.initConfigurations = function (next, fallback) {
    ...
    if (typeof NA.controllers[NA.webconfig.commonController] !== 'undefined' &&
        typeof NA.controllers[NA.webconfig.commonController].setConfigurations !== 'undefined') {
             ...
             */
            NA.controllers[NA.webconfig.commonController].setConfigurations.call(NA, function () {
