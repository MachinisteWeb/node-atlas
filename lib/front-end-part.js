...
exports.prepareRenderPath = function (currentVariation, currentRouteParameters, request, response, templatesPath, currentPath, path) {
    ...
    console.log("urlRootPath", currentVariation.urlRootPath);
    console.log("urlSubPath", currentVariation.urlSubPath);
    console.log("urlBasePath", currentVariation.urlBasePath);
    console.log("urlFilePath", currentVariation.urlFilePath);
    console.log("urlQueryPath", currentVariation.urlQueryPath);
