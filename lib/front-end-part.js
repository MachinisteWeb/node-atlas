 ...
 */
exports.openTemplate = function (currentRouteParameters, viewsPath, callback) {
    var NA = this,
        fs = NA.modules.fs;
    ...
    fs.readFile(viewsPath, 'utf-8', function (err, data) {
        if (err) {
            ...
            if (typeof currentRouteParameters.view === 'undefined') {
 ...
 */
exports.prepareRenderLanguage = function (currentVariation, currentRouteParameters, request, response, viewsPath, currentPath, path) {
    var NA = this;
    ...
    NA.prepareRenderPath(currentVariation, currentRouteParameters, request, response, viewsPath, currentPath, path);
};
 ...
 * @param {string} path                   Url path for this render.
 */
exports.prepareRenderPath = function (currentVariation, currentRouteParameters, request, response, viewsPath, currentPath, path) {
    var NA = this,
    ...
    /* Next preparation render for variation. */
    NA.prepareRenderVariation(currentVariation, currentRouteParameters, request, response, viewsPath, currentPath, path);
};
 ...
 * @param {string} path                   Url path for this render.
 */
exports.prepareRenderVariation = function (currentVariation, currentRouteParameters, request, response, viewsPath, currentPath, path) {
    var NA = this,
    ...
    NA.prepareRenderParameters(currentVariation, currentRouteParameters, request, response, viewsPath, currentPath, path);
};
 ...
 * @param {string} path                   Url path for this render.
 */
exports.prepareRenderParameters = function (currentVariation, currentRouteParameters, request, response, viewsPath, currentPath, path) {
    var NA = this;
    ...
    /* Nexts Step for render. */
    NA.changeVariationCommon(currentVariation, currentRouteParameters, request, response, viewsPath, currentPath, path);
};
 ...
 * @param {string} currentPath            Url from `url` value for this render.
 */
exports.changeVariationCommon = function (currentVariation, currentRouteParameters, request, response, viewsPath, currentPath) {
    var NA = this;
    ...
    if (typeof NA.websiteController[NA.webconfig.commonController] !== 'undefined' &&
        typeof NA.websiteController[NA.webconfig.commonController].changeVariation !== 'undefined') {
            ...
            function (tempVariation) {
                ...
                NA.changeVariationSpecific(currentVariation, currentRouteParameters, request, response, viewsPath, currentPath);
            });
    /* ...else, just continue. */
    } else {
        NA.changeVariationSpecific(currentVariation, currentRouteParameters, request, response, viewsPath, currentPath);
 ...
 * @param {string} currentPath            Url from `url` value for this render.
 */
exports.changeVariationSpecific = function (currentVariation, currentRouteParameters, request, response, viewsPath, currentPath) {
    var NA = this;
    ...
    if (typeof NA.websiteController[currentRouteParameters.controller] !== 'undefined' &&
        typeof NA.websiteController[currentRouteParameters.controller].changeVariation !== 'undefined') {
            ...
            NA.websiteController[currentRouteParameters.controller].changeVariation.call(NA, { variation: currentVariation, request: request, response: response }, function (tempVariation) {
                currentVariation = (tempVariation) ? tempVariation : currentVariation;
                NA.changeDomCommon(currentVariation, currentRouteParameters, request, response, viewsPath, currentPath);
            });
    } else {
        /* ...else, just continue. */
        NA.changeDomCommon(currentVariation, currentRouteParameters, request, response, viewsPath, currentPath);
 ...
 * @param {string} currentPath            Url from `url` value for this render.
 */
exports.changeDomCommon = function (currentVariation, currentRouteParameters, request, response, viewsPath, currentPath) {
    var NA = this,
        ejs = NA.modules.ejs,
        pug = NA.modules.pug,
    ...
    NA.openTemplate(currentRouteParameters, viewsPath, function (data) {
        var engine = NA.webconfig.enablePug ? pug : ejs;

        if (typeof currentRouteParameters.enablePug === "boolean") {
            /**
             ...
             * @default undefined
             */
            engine = currentRouteParameters.enablePug ? pug : ejs;
        }

        /* Set the file currently in use. */
        currentVariation.filename = pathM.join(currentVariation.pathname, currentRouteParameters.view);
...
exports.renderTemplate = function (data, currentVariation, currentRouteParameters, request, response, currentPath) {
    ...
    if (typeof response === 'undefined' || (htmlGenerationBeforeResponse && htmlGenerationEnable)) {
        ...
        if (typeof currentRouteParameters.output !== 'undefined') {
            templateRenderName = currentRouteParameters.output;
        }
...
exports.render = function (path, options, request, response) {
    ...
    if (typeof currentRouteParameters === 'string') {
        ...
        viewsPath = currentRouteParameters;
        currentRouteParameters = {};
         ...
         * @memberOf NA#currentRouteParameters
         */
        currentRouteParameters.view = viewsPath;
    }
    ...
    viewsPath = pathM.join(
        ...
        (currentRouteParameters.view) ? currentRouteParameters.view : ""
    );
    ...
    NA.loadController(
        ...
        function () {
            ...
            NA.prepareRenderLanguage(currentVariation, currentRouteParameters, request, response, viewsPath, currentPath, path);
        }
    );
};