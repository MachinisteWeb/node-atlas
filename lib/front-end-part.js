 ...
 * @param {string} currentPath     Url from `url` value for this render.
 */
function engineProcess(NA, data, locals, routeParameters, response, next) {
    ...
    //if (NA.webconfig.commonEngine) {
        ...
        /*response.render(data, locals, function (err, data) {
            if (err) {
                data = err.toString();
            }
...
exports.changeDomCommon = function (locals, routeParameters, request, response, viewsPath, currentPath) {
    ...
    NA.openTemplate(routeParameters, viewsPath, function (data) {
        ...
        // Transform into HTML
        engineProcess(NA, data, locals, routeParameters, response, function (data) {
